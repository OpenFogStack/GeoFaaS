...
fun main(args: Array<String>) {
    ...
    val locations = Commons.locScenario1Long
    Measurement.log("", -1, "ScenarioDistance (locSize)", locations.size.toString(), null)
    ...
    val elapsed = measureTimeMillis {
        locations.forEachIndexed { i, loc ->
            ...
            val res: Pair<FunctionMessage?, Long> = client.call("sieve",  "", reqId, 1, 2, isContinousCall = true)
